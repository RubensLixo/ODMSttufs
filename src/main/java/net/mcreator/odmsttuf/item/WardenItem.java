...
public abstract class WardenItem extends ArmorItem {
	public WardenItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{10, 14, 16, 10}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends WardenItem {
		public Helmet() {
	...
	public static class Chestplate extends WardenItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			super.inventoryTick(itemstack, world, entity, slot, selected);
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				WardenChestplateTickEventProcedure.execute(world, entity, itemstack);
			}
		}
	}

	public static class Leggings extends WardenItem {
		public Leggings() {
